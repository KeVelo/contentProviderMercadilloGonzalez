package sv.edu.ufg.amb.containprovidermercadillogonzalez
...
class MainActivity : AppCompatActivity() {
    ...
    private fun createImageUri():Uri{
        ...
        return FileProvider.getUriForFile(this, "sv.edu.ufg.amb.containprovidermercadillogonzalez.FileProvider",imagen)
    }
